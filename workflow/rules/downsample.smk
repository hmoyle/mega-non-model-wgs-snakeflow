...
rule genomics_db_import_scaffold_groups_ds:
    ...
    params:
        my_opts=" --batch-size 50 --reader-threads 2 --genomicsdb-shared-posixfs-optimizations --intervals results/bqsr-round-{bqsr_round}/downsample-{cov}X/gdb_intervals/{scaff_group}.list --merge-contigs-into-num-partitions 1  --genomicsdb-workspace-path ",
        java_opts="-Xmx4g",  # optional
    resources:
        mem_mb = 9400,
        cpus = 2,
